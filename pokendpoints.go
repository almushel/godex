...
type Pokemon struct {
	...
	Abilities      []struct {
		...
		Slot     int  `json:"slot"`
		Ability  PokeEndpoint
	} `json:"abilities"`
	Forms       []PokeEndpoint
	GameIndices []struct {
		GameIndex int `json:"game_index"`
		Version   PokeEndpoint
	} `json:"game_indices"`
	HeldItems []struct {
		Item           PokeEndpoint
		VersionDetails []struct {
	...
	Moves                  []struct {
		...
		VersionGroupDetails []struct {
			...
			VersionGroup    PokeEndpoint `json:"version_group"`
			MoveLearnMethod PokeEndpoint `json:"move_learn_method"`
		} `json:"version_group_details"`
	} `json:"moves"`
	Species PokeEndpoint
	Sprites struct {
		BackDefault      string `json:"back_default"`
